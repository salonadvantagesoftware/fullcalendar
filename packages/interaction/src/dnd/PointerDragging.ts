...
export class PointerDragging {
  ...
  handleMouseDown = (ev: MouseEvent) => {
    if (
      ...
      (isPrimaryMouseButton(ev) || isSecondaryMouseButton(ev)) &&
      this.tryStart(ev)
    ) {
...
// Returns a boolean whether this was a right mouse click and no ctrl key
function isSecondaryMouseButton(ev: MouseEvent) {
